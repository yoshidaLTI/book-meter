...
void update_progress(sqlite3 *db) {
    ...
    if (sqlite3_step(stmt) == SQLITE_ROW) {
        ...
        char date[32];
コマンドを入力してください（[Ctrl]+C または exit で終了）：
使用可能なコマンド:
  add   - 本を追加
  list  - 登録された本の一覧を表示
  progress - 読書進捗を記録・表示
...
作者名を入力してください：夏目漱石
ページ数を入力してください：600
発行日を入力してください（例：2025-04-23）：2000－1－1
本を登録しました。
command>> ぃｓ   


^C
voclabs:~/environment/workspace $ ./book
コマンドを入力してください（[Ctrl]+C または exit で終了）：
使用可能なコマンド:
  add   - 本を追加
  list  - 登録された本の一覧を表示
...
command>> list
登録された本の一覧：
[1] こころ | 夏目漱石 | 500ページ | 発行日: 1980-4-1 | 読了: 400ページ
[2] こころ | 夏目漱石 | 600ページ | 発行日: 2000－1－1 | 読了: 0ページ
command>> progress
対象の本のIDを入力してください：2
今日読んだページ数を入力してください：400
現在の進捗状況: 400/600ページ (66.67%)
[#############       ]
command>> help
使用可能なコマンド:
  add   - 本を追加
...
使用可能なコマンド:
  ...
  exit  - プログラムを終了
command>> add
本のタイトルを入力してください：LTI完全理解BOOK
作者名を入力してください：yoshida
ページ数を入力してください：600
発行日を入力してください（例：2025-04-23）：2025-04-3
本を登録しました。
command>> list
登録された本の一覧：
[1] こころ | 夏目漱石 | 500ページ | 発行日: 1980-4-1 | 読了: 400ページ
[2] こころ | 夏目漱石 | 600ページ | 発行日: 2000－1－1 | 読了: 400ページ
[3] LTI完全理解BOOK | yoshida | 600ページ | 発行日: 2025-04-3 | 読了: 0ページ
command>> 
...
command>> progress
対象の本のIDを入力してください：3
今日読んだページ数を入力してください：200
現在の進捗状況: 200/600ページ (33.33%)
[######              ]
command>> ^C
voclabs:~/environment/workspace $ 
voclabs:~/environment/workspace $ 
